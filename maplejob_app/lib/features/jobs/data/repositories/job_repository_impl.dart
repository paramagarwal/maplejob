...
class JobRepositoryImpl implements JobRepository {
  ...
  Future<void> saveJob(String userId, String jobId) async {
    await _firestoreService.saveJob(userId, jobId);
  }

  @override
  Future<void> unsaveJob(String userId, String jobId) async {
    await _firestoreService.unsaveJob(userId, jobId);
  }

  @override
  Stream<List<String>> getSavedJobIds(String userId) {
    return _firestoreService.getSavedJobIdsStream(userId).map((snapshot) {
